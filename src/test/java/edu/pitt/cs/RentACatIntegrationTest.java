...
public class RentACatIntegrationTest {
	...
	public void testGetCatNumCats3() throws Exception {
		...
		assertEquals("Old Deuteronomy", result.getName());
	}
	...
	public void testListCatsNumCats3() {
		...
		String returnValue = "ID 1. Jennyanydots" +newline + "ID 2. Old Deuteronomy" + newline + "ID 3. Mistoffelees" + newline;

		assertEquals(returnValue, r.listCats());
	}
